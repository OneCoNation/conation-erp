...
// Colors
$colorbackbody = '243,245,248'; // GSM Body BG
$colorbackhmenu1 = '255,255,255'; // topmenu
...
$colorbacklinepairhover = '255,249,245'; // GSM Hover Tint
$colorbacklinepairchecked = '255,245,242'; // GSM Checked Tint
$colorbacklinebreak = '248,247,244'; // line break
$colortexttitlenotab = '132, 53, 35'; // GSM Primary
$colortexttitlenotab2 = '132, 53, 35'; // GSM Primary
$colortexttitle = '17, 24, 39'; // GSM Dark Text
$colortexttitlelink = '132, 53, 35'; // GSM Primary
$colortext = '17, 24, 39'; // GSM Dark Text
$colortextlink = '132, 53, 35'; // GSM Primary
$fontsize = '0.92em';
$fontsizesmaller = '0.75em';
$topMenuFontSize = '1.1em';
$toolTipBgColor = 'rgba(255, 255, 255, 0.98)';
$toolTipFontColor = '#111827';
$butactionbg = '132, 53, 35'; // GSM Primary
...
/* default color for status : After a quick check, somme status can have opposite function according to objects *  So this badges status uses default value according to theme eldy status img *  TODO: use color definition vars above for define badges color status X -> example $badgeStatusValidate, $badgeStatusClosed, $badgeStatusActive .... */
